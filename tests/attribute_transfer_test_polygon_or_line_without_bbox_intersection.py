...
from create_dummy_data import create_dummy_data_without_bbox_intersection
...
class AttributeTransferTestPolygonOrLineWithoutBboxIntersection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        create_dummy_data_without_bbox_intersection(self.source_layer, self.target_layer)
        self.widget.initGui()
